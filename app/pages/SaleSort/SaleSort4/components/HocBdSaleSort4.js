...
const HocBdSaleSort4 = (WrappedComponent) => {
    return (
        class HocBdSaleSort4 extends WrappedComponent {
            render() {
                return super.render();
            }
            ...
            fetchTableData = (currentPage = 1, size = 10) => {
                ...
                callAxios({
                    that: this,
                    method: 'get',
                    url: `${API.findSaleSortGoods}?saleSortId=4&page=${currentPage - 1}&size=${size}${filter}`,
                })
                .then((response) => {
                    let {
                        content = [],
            ...
            handleRowDeleteClick = (id, index) => {
                ...
                callAxios({
                    that: this,
                    method: 'delete',
                    url: `${API.deleteSortGoods}?goodsId=${id}&saleSortId=4`,
                })
                .then((response) => {
