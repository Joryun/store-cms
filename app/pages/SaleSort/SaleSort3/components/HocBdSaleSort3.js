...
const HocBdSaleSort3 = (WrappedComponent) => {
    return (
        class HocBdSaleSort3 extends WrappedComponent {
            render() {
                return super.render();
            }
            ...
            fetchTableData = (currentPage = 1, size = 10) => {
                ...
                callAxios({
                    that: this,
                    method: 'get',
                    url: `${API.findSaleSortGoods}?saleSortId=3&page=${currentPage - 1}&size=${size}${filter}`,
                })
                .then((response) => {
                    let {
                        content = [],
            ...
            handleRowDeleteClick = (id, index) => {
                ...
                callAxios({
                    that: this,
                    method: 'delete',
                    url: `${API.deleteSortGoods}?goodsId=${id}&saleSortId=3`,
                })
                .then((response) => {
