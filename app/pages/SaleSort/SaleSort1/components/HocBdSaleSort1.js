...
const HocBdSaleSort1 = (WrappedComponent) => {
    return (
        class HocBdSaleSort1 extends WrappedComponent {
            render() {
                return super.render();
            }
            ...
            fetchTableData = (currentPage = 1, size = 10) => {
                ...
                callAxios({
                    that: this,
                    method: 'get',
                    url: `${API.findSaleSortGoods}?saleSortId=1&page=${currentPage - 1}&size=${size}${filter}`,
                })
                .then((response) => {
                    let {
                        content = [],
            ...
            handleRowDeleteClick = (id, index) => {
                ...
                callAxios({
                    that: this,
                    method: 'delete',
                    url: `${API.deleteSortGoods}?goodsId=${id}&saleSortId=1`,
                })
                .then((response) => {
